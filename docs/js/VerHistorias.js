...
// [1] Exibe usuário logado / controle de likes
...
function createStoryCard(story) {
  ...
  mais.onclick = () => {
    isUserLoggedIn = isUserLoggedIn; // só abre modal
  ...
  // Likes — somente para usuário logado
  if (isUserLoggedIn) {
    ...
    let userLiked = false; // sem localStorage
