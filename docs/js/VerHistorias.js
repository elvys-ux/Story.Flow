...
function createPlaceholderCard() {
  ...
  const h3 = document.createElement('h3'); h3.textContent = 'Carregando...'; div.appendChild(h3);
  const p = document.createElement('p'); p.textContent = '...'; div.appendChild(p);
  return div;
}
...
// [3] Busca histórias, cartões, categorias e curtidas
